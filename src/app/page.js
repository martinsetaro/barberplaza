...
export default function Home() {
  ...
  return (
    ...
    <Script src="https://www.googletagmanager.com/gtag/js?id=G-XJQTMDLY80" />
     ...
     className=" bg-white text-2xl font-lora font-bold py-2 mb-4 mt-8 px-4 rounded-xl shadow-lg hover:transform hover:rotate-360 hover:scale-95 hover:duration-500 hover:bg-slate-600 hover:text-white max-[900px]:w-full max-[900px]:h-[6rem] max-[900px]:text-2xl">Ingresa a tu barberia</button></Link>
     <Link href="/Registro"><button 
     className="bg-white text-2xl font-lora font-bold py-2 mb-8 mt-8 px-4 rounded-xl shadow-lg hover:transform hover:rotate-360 hover:scale-95 hover:duration-500 hover:bg-slate-600 hover:text-white max-[900px]:w-full max-[900px]:h-[6rem] max-[900px]:text-2xl">Registra tu barberia</button></Link>
     <Link href="/Turnos"><button 
     className=" bg-blue-600 text-2xl text-white font-lora font-bold py-2 mb-4 mt-4 px-4 rounded-xl shadow-lg hover:transform hover:rotate-360 hover:scale-95 hover:duration-500 hover:bg-gradient-to-r from-blue-400 to-blue-600 hover:border-blue-700 hover:border-2 max-[900px]:w-full max-[900px]:h-[6rem] max-[900px]:text-2xl ">Solicitar un turno</button></Link>
